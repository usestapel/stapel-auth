...
class QRGenerateResponse:
    ...
    Attributes:
        ...
        scan_url: The URL to encode inside the QR image. When a phone camera scans the QR code it opens this URL on the scanner's device, which triggers the auth flow. Pass this to your QR-code renderer (e.g. qrcode.js). Example: https://app.ironmemo.com/auth/api/qr/abc123xyz/scan/
    """
    key: str
    type: QRType
    expires_in: int

...
```bash
git clone https://github.com/usestapel/stapel-auth.git && cd stapel-auth
...
The packages use a flat layout (`package-dir = {{"stapel_auth": "."}}`), so the

...
class AuditLogViewSet(ViewSet):
    ...
    @extend_schema(
        ...
        parameters=[
            ...
            OpenApiParameter('date_from', str, required=False, description='ISO date, e.g. 2026-01-01'),
            OpenApiParameter('date_to', str, required=False, description='ISO date, e.g. 2026-12-31'),
...
class RevokeSuspiciousView(APIView):
    ...
    def get(self, request):
        ...
        from stapel_auth.models import UserSession, AuthEventType

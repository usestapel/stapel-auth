...
_EXPECTED_URLS = {
    ...
    'password_forced_change': 'password/forced-change/',
    ...
    'totp_delayed_initiate': 'totp/change/delayed/initiate/',
    'totp_delayed_status': 'totp/change/delayed/status/',
    'totp_delayed_cancel': 'totp/change/delayed/cancel/',
    ...
    'mfa_enroll_exchange': 'mfa/enroll/exchange/',
...
class URLFactoryEquivalenceTests(TestCase):
    ...
    def test_factories_cover_expected_urls_exactly_once(self):
        ...
        for factory in (
            ...
            auth_urls.get_login_grant_urls,

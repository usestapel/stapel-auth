def pytest_configure(config):
    ...
    settings.configure(
        ...
        MIDDLEWARE=[
            ...
            "stapel_core.django.middleware.JWTAuthMiddleware",
            "stapel_core.django.admin_redirect_middleware.AdminLoginRedirectMiddleware",
            "stapel_core.django.middleware.ServiceAPIKeyMiddleware",

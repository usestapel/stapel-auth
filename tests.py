...
class EmailAuthenticationTests(APITestCase):
    ...
    def test_email_request_otp_success(self, mock_send):
        ...
        response = self.client.post(reverse('email_request'), {
    ...
    def test_email_verify_new_user_returns_registered(self, mock_verify):
        ...
        response = self.client.post(reverse('email_verify'), {
...
class PhoneAuthenticationTests(APITestCase):
    ...
    def test_phone_verify_new_user_returns_registered(self, mock_verify):
        ...
        response = self.client.post(reverse('phone_verify'), {
            'phone': '+12025559876',
            'code': '1234'
        })
...
@override_settings(URL_PREFIX='', AUTHENTICATION_BACKENDS=['django.contrib.auth.backends.ModelBackend'])
...
class EmailVerificationEdgeCaseTests(APITestCase):
    ...
    def test_email_verify_anonymous_user_registers(self):
        ...
        # Verify email
        response = self.client.post(reverse('email_verify'), {
            'email': 'anon-register@example.com',
            'code': '1234'
        })
...
class EmailRequestEdgeCaseTests(APITestCase):
    ...
    def test_email_request_rate_limit(self):
        ...
        # Second request immediately
        response = self.client.post(reverse('email_request'), {'email': 'rate@example.com'})
...
class PhoneRequestEdgeCaseTests(APITestCase):
    ...
    def test_phone_request_authenticated_conflict(self):
        ...
        response = self.client.post(reverse('phone_request'), {
            'phone': '+12345678911'
        })
...
class LoginAttemptTests(TestCase):
    ...
    def test_login_attempt_created_on_failed_email_verify(self):
        ...
        # Wrong code
        client.post(reverse('email_verify'), {
...
class ConvertAnonymousUserSerializerTests(TestCase):
    ...
    def test_convert_anonymous_requires_email_or_phone(self):
        ...
        from .serializers import ConvertAnonymousUserSerializer
...
class AuthenticatorChangeServiceTests(TestCase):
    ...
    def test_is_value_available_excludes_self(self):
        ...
        self.assertTrue(self.service.is_value_available('+12025551000', 'phone', exclude_user=self.user))
    ...
    def test_request_old_otp_no_phone(self):
        ...
        user_no_phone = User.objects.create_user(
            email='nophone@example.com', username='nophone',
        )
    ...
    def test_verify_old_otp_creates_change_request(self):
        ...
        req = AuthenticatorChangeRequest.objects.get(
            user=self.user, change_type='phone', status=AuthenticatorChangeStatus.PENDING
        )
    ...
    def test_request_new_otp_invalid_token(self):
        ...
        result = self.service.request_new_otp(self.user, 'phone', '+13125553333', str(uuid.uuid4()))
    ...
    def test_verify_new_and_apply_success(self):
        ...
        result = self.service.verify_new_and_apply(self.user, 'phone', '+13125555555', '0000', token)
        self.assertTrue(result.get('success'))
    ...
    def test_verify_new_value_mismatch(self):
        ...
        self.service.request_new_otp(self.user, 'phone', '+13125555555', token)
        result = self.service.verify_new_and_apply(self.user, 'phone', '+13125556666', '0000', token)
    ...
    def test_initiate_delayed_success(self):
        ...
        result = self.service.initiate_delayed(
            self.user, 'phone', '+13125557777',
            device_id='dev-1', ip='1.2.3.4', user_agent='test',
        )
        self.assertTrue(result.get('success'))
    ...
    def test_cancel_pending_success(self):
        ...
        cancel_result = self.service.cancel_pending(
            self.user, 'phone', result['change_request_id'],
        )
...
@override_settings(URL_PREFIX='', USE_MOCK_SMS_OTP=True, USE_MOCK_EMAIL_OTP=True, MOCK_OTP_CODE='0000')
class PhoneInstantChangeViewTests(APITestCase):
    ...
    def test_verify_old_success(self):
        ...
        response = self.client.post(reverse('phone_instant_verify_old'), {'code': '0000'})
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_verify_old_wrong_code(self):
        self.client.post(reverse('phone_instant_request_old'), {})
        response = self.client.post(reverse('phone_instant_verify_old'), {'code': '9999'})
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_request_new_success(self):
        ...
        response = self.client.post(reverse('phone_instant_request_new'), {
            'phone': '+13125551234', 'change_token': token,
        })
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_request_new_taken_phone(self):
        ...
        response = self.client.post(reverse('phone_instant_request_new'), {
            'phone': '+13125559876', 'change_token': token,
        })
        self.assertEqual(response.status_code, status.HTTP_409_CONFLICT)
    ...
    def test_full_instant_phone_change(self):
        ...
        # Step 3: request new
        self.client.post(reverse('phone_instant_request_new'), {
            'phone': '+13125550099', 'change_token': token,
        })
        # Step 4: verify new
        resp4 = self.client.post(reverse('phone_instant_verify_new'), {
    ...
    def test_verify_new_missing_phone(self):
        ...
        response = self.client.post(reverse('phone_instant_verify_new'), {
            'email': 'x@x.com', 'code': '0000', 'change_token': token,
        })
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
...
class EmailInstantChangeViewTests(APITestCase):
    ...
    def test_full_instant_email_change(self):
        ...
        self.client.post(reverse('email_instant_request_new'), {
            'email': 'newemail@example.com', 'change_token': token,
        })
        resp4 = self.client.post(reverse('email_instant_verify_new'), {
            'email': 'newemail@example.com', 'code': '0000', 'change_token': token,
        })
        self.assertEqual(resp4.status_code, status.HTTP_200_OK)
        self.assertEqual(resp4.data['status'], 'MODIFIED')
...
class PhoneDelayedChangeViewTests(APITestCase):
    ...
    def test_initiate_success(self):
        response = self.client.post(reverse('phone_delayed_initiate'), {
            'phone': '+13125550100',
        })
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_cancel_success(self):
        resp = self.client.post(reverse('phone_delayed_initiate'), {'phone': '+13125550400'})
        req_id = resp.data['change_request_id']

        response = self.client.post(reverse('phone_delayed_cancel'), {
...
class EmailDelayedChangeViewTests(APITestCase):
    ...
    def test_initiate_success(self):
        response = self.client.post(reverse('email_delayed_initiate'), {
    ...
    def test_status_and_cancel(self):
        resp = self.client.post(reverse('email_delayed_initiate'), {
        ...
        # Cancel
        cancel_resp = self.client.post(reverse('email_delayed_cancel'), {
            'change_request_id': req_id,
        })
...
class AuthenticatorChangeRequestModelTests(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email='model@example.com', username='modeluser', phone='+12025551600',
        )

    def test_str_representation(self):
        req = AuthenticatorChangeRequest.objects.create(
            user=self.user, change_type='phone',
            old_value='+12025551600', new_value='+13125551200',
            scheduled_at=timezone.now() + timedelta(days=14),
        )
        s = str(req)
    ...
    def test_unique_pending_per_user_type(self):
        ...
        AuthenticatorChangeRequest.objects.create(
            user=self.user, change_type='phone',
            old_value='+12025551600', new_value='+13125551300',
            scheduled_at=timezone.now() + timedelta(days=14),
        )
        with self.assertRaises(IntegrityError):
            AuthenticatorChangeRequest.objects.create(
                user=self.user, change_type='phone',
                old_value='+12025551600', new_value='+13125551400',
                scheduled_at=timezone.now() + timedelta(days=14),
            )
    ...
    def test_unique_pending_reservation(self):
        ...
        other_user = User.objects.create_user(
            email='other2@example.com', username='other2', phone='+12025551601',
        )
        AuthenticatorChangeRequest.objects.create(
            user=self.user, change_type='phone',
            old_value='+12025551600', new_value='+13125551500',
            scheduled_at=timezone.now() + timedelta(days=14),
        )
        with self.assertRaises(IntegrityError):
            AuthenticatorChangeRequest.objects.create(
                user=other_user, change_type='phone',
                old_value='+12025551601', new_value='+13125551500',
                scheduled_at=timezone.now() + timedelta(days=14),
            )
    ...
    def test_cancelled_does_not_block_constraint(self):
        ...
        AuthenticatorChangeRequest.objects.create(
            user=self.user, change_type='phone',
            old_value='+12025551600', new_value='+13125551600',
            scheduled_at=timezone.now() + timedelta(days=14),
        ...
        req = AuthenticatorChangeRequest.objects.create(
            user=self.user, change_type='phone',
            old_value='+12025551600', new_value='+13125551700',
            scheduled_at=timezone.now() + timedelta(days=14),
        )
        self.assertEqual(req.status, AuthenticatorChangeStatus.PENDING)
...
class ChangeSerializerTests(TestCase):
    ...
    def test_instant_request_new_requires_phone_or_email(self):
        from .serializers import InstantChangeRequestNewSerializer
        serializer = InstantChangeRequestNewSerializer(data={
    ...
    def test_delayed_initiate_requires_value(self):
        from .serializers import DelayedChangeInitiateSerializer
    ...
    def test_delayed_cancel_requires_uuid(self):
        from .serializers import DelayedChangeCancelSerializer
        serializer = DelayedChangeCancelSerializer(data={'change_request_id': 'not-a-uuid'})
        self.assertFalse(serializer.is_valid())

    def test_delayed_cancel_valid_uuid(self):
        from .serializers import DelayedChangeCancelSerializer
        serializer = DelayedChangeCancelSerializer(data={
            'change_request_id': str(uuid.uuid4()),
        })
        self.assertTrue(serializer.is_valid())
...
class PasswordLoginTests(APITestCase):
    ...
    def test_login_wrong_password(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
        self.assertEqual(response.data['localizable_error'], 'error.401.invalid_credentials')
    ...
    def test_login_inactive_user(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
        self.assertEqual(response.data['localizable_error'], 'error.401.account_disabled')

    def test_login_missing_fields(self):
        response = self.client.post(reverse('password_login'), {'login': 'login@example.com'})
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
...
class PasswordMethodsTests(APITestCase):
    ...
    def test_methods_with_verified_email(self):
        user = User.objects.create_user(
            username='emailuser', email='e@x.com', is_email_verified=True,
        )
        self._auth(user)
        response = self.client.get(reverse('password_methods'))
        methods = [m['method'] for m in response.data['methods']]
        self.assertIn('email', methods)
        email_method = next(m for m in response.data['methods'] if m['method'] == 'email')
        self.assertIn('target', email_method)
        self.assertIn('***', email_method['target'])

    def test_methods_with_verified_phone(self):
        user = User.objects.create_user(
            username='phoneuser2', phone='+79991234567', is_phone_verified=True,
        )
        self._auth(user)
        response = self.client.get(reverse('password_methods'))
        methods = [m['method'] for m in response.data['methods']]
    ...
    def test_methods_unverified_email_excluded(self):
        user = User.objects.create_user(
            username='unverified', email='u@x.com', is_email_verified=False,
        )
        self._auth(user)
        response = self.client.get(reverse('password_methods'))
        methods = [m['method'] for m in response.data['methods']]
...
class PasswordChangeDirectTests(APITestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = User.objects.create_user(
            username='changeuser', password='oldpass123',
        )
...
class PasswordChangeOtpTests(APITestCase):
    ...
    def test_request_otp_email(self, mock_send):
        ...
        response = self.client.post(reverse('password_change_otp_request'), {'method': 'email'})
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_request_otp_phone(self, mock_send):
        mock_send.return_value = MagicMock()
        response = self.client.post(reverse('password_change_otp_request'), {'method': 'phone'})
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_request_otp_no_verified_email(self):
        user = User.objects.create_user(
            username='noemail', email='no@x.com', is_email_verified=False,
        )
        access, _ = create_token_for_user(user)
        self.client.credentials(HTTP_AUTHORIZATION=f'Bearer {access}')
        response = self.client.post(reverse('password_change_otp_request'), {'method': 'email'})
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data['localizable_error'], 'error.400.no_verified_contact')

    def test_request_otp_invalid_method(self):
        response = self.client.post(reverse('password_change_otp_request'), {'method': 'fax'})
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)

    @patch('stapel_auth.services.EmailVerificationService.verify_code')
    def test_verify_otp_email_success(self, mock_verify):
        mock_verify.return_value = {'success': True}
        response = self.client.post(reverse('password_change_otp_verify'), {
            'method': 'email',
            'code': '1234',
    ...
    def test_verify_otp_wrong_code(self, mock_verify):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data['localizable_error'], 'error.400.invalid_code_attempts')
...
class PasswordResetEmailTests(APITestCase):
    ...
    def test_request_success(self, mock_send):
        mock_send.return_value = MagicMock()
        response = self.client.post(reverse('password_reset_email_request'), {
            'email': 'reset@example.com',
        })
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertIn('target', response.data)
    ...
    def test_request_unverified_email(self):
        User.objects.create_user(
            username='unverified2', email='unverified@example.com', is_email_verified=False,
        )
        response = self.client.post(reverse('password_reset_email_request'), {
    ...
    def test_verify_success_logs_in_user(self, mock_verify):
        mock_verify.return_value = {'success': True}
        response = self.client.post(reverse('password_reset_email_verify'), {
            'email': 'reset@example.com',
            'code': '1234',
...
class PasswordResetPhoneTests(APITestCase):
    ...
    def test_request_success(self, mock_send):
        mock_send.return_value = MagicMock()
        response = self.client.post(reverse('password_reset_phone_request'), {
            'phone': '+79991234560',
        })
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertIn('target', response.data)
    ...
    def test_verify_success_logs_in_user(self, mock_verify):
        mock_verify.return_value = {'success': True}
        response = self.client.post(reverse('password_reset_phone_verify'), {
            'phone': '+79991234560',
            'code': '1234',
            'new_password': 'freshpass789!',
        })
...
class MockAdminOtpBlockTests(APITestCase):
    ...
    def test_regular_user_not_blocked(self):
        ...
        with patch('stapel_auth.services.EmailVerificationService.send_verification_code') as m:
...
class QRAuthGenerateTests(APITestCase):
    ...
    def test_generate_session_share_requires_auth(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
        self.assertEqual(response.data['localizable_error'], 'error.401.qr_auth_required')
    ...
    def test_generate_with_redirect_url(self):
        ...
        response = self.client.post(reverse('qr_generate'), {
            'type': 'session_share',
            'redirect_url': 'https://app.ironmemo.com/home',
        })
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
...
class QRAuthStatusTests(APITestCase):
    ...
    def test_status_expired_for_unknown_key(self):
        response = self.client.get(reverse('qr_status', kwargs={'key': 'nonexistent_key_xyz'}))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class QRAuthConfirmTests(APITestCase):
    ...
    def test_confirm_wrong_type_session_share(self):
        ...
        response = self.client.post(reverse('qr_confirm', kwargs={'key': key}))
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data['localizable_error'], 'error.400.qr_type_required')
...
class QRAuthScanTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.owner = User.objects.create_user(
            username='scanowner', password='pass', email='owner@x.com',
        )
    ...
    def _generate_session_share_key(self):
        ...
        resp = c.post(reverse('qr_generate'), {
            'type': 'session_share',
            'redirect_url': 'https://app.ironmemo.com/',
        })
